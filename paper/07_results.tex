...
\begin{figure}[t]
\centering
\includegraphics[width=3.4in]{figures/F5_served_value.pdf}
...
5). H2 carries only corrected-horizon data: an earlier censored-horizon
...
\begin{figure}[t]
\centering
\includegraphics[width=3.4in]{figures/F3_containment_starvation.pdf}
...
cut off at exactly its budget (Figure 3, Table 3). The comparison column,
